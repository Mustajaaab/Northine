...
const MainFooter = () => {
    return (
        <div className="relative bg-gradient-to-b from-gradientStart to-gradientEnd ">
            {/* Background Image */}
            <div
                className="absolute inset-28 bg-no-repeat bg-center bg-cover opacity-10"
                style={{ backgroundImage: `url(${DotBg})` }}
            ></div>

            <div className="relative flex justify-end w-[33%]">
            ...
            <div className="relative">
                ...
                <div className="text-center">
                    <h1 className="text-white font-syne font-semibold text-[43px] mt-5">
                        Let&apos;s <span className="text-yellow">Open the World</span> of IT to You
                    </h1>
                    <p className="text-white/30 font-syne font-medium mt-5">
                        Recognizes exceptional websites with outstanding visual appeal and technical functionality.
                    </p>
                    <button className="border-[2px] border-yellow hover:border-[4px] mt-10 bg-transparent font-syne text-[18px] font-normal w-[302px] hover:py-[23px] py-[25px] rounded-full text-white ease-in-out duration-300 transition-transform">
                        Book an Appointment
                    </button>
                </div>
            </div>
