            ...
            <div className="pt-[89px]">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {[
                        ...
                        { title: "Ghostwriting", index: 1 },
                        { title: "Copywriting", index: 2 },
                        { title: "Social media management", index: 3 },
                        { title: "On page seo", index: 4 },
                        { title: "Email marketing ", index: 5 },
                    ].map((skill, idx) => (
