...
const slides = [
  {
    ...
    mainDesc:
      "We designed the ChainRaise web app to make digital asset trading more accessible and engaging. Key features included:",
    mark: "Simple and efficient trade execution",
    flag: "Secure transaction processing",
    cube: "Clear and visually appealing dashboards",
    search: "Customizable notifications",
    order1: "order-1",
    order2: "order-2",
    link: "/case-studies1",
  },

  {
    ...
    mainDesc: "The new ChainRaise web app delivered",
    mark: "Higher user engagement",
    flag: "Increased customer confidence",
    cube: "Improved customer satisfaction",
    search: "Stronger customer satisfaction",
    order1: "order-2",
    order2: "order-1",
  },
];
        ...
        <div className="grid grid-cols-3 gap-4 pt-[100px]">
          <div className="col-span-2 pe-20">
            ...
            <p className="text-black/30 text-base font-syne mb-[20px] mt-[20px]">
              Navigating the world of digital assets can be overwhelming,
              especially for new traders. ChainRaise aimed to offer a seamless,
            ...
            <p className="text-black/30 text-base font-syne mb-[20px] mt-[20px]">
              To tackle these challenges, NorthNine designed a platform that
              focused on simplicity, security, and efficiency. Our approach
              included:
            </p>
            <div className="mt-[30px] grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
                <p className="text-lg font-syne">User-friendly navigation </p>
              </div>
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
                <p className="text-lg font-syne">
              ...
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
                <p className="text-lg font-syne">Robust security measures</p>
              </div>
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
                <p className="text-lg font-syne">
        ...
        <div className="grid grid-cols-2 my-[90px]">
          <div>
            ...
            <p className="text-black/30">
              By focusing on accessibility, security, and user experience, we
              helped ChainRaise create a powerful yet easy-to-use trading
              platform. The result? A seamless digital asset trading experience
              that boosts user confidence, increases engagement, and drives
              long-term retention.
            </p>
          </div>
        </div>
