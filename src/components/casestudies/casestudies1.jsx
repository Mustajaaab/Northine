...
const slides = [
  {
    ...
    mainDesc:
      "Using Figma, we crafted a mobile app that balanced aesthetics and functionality. Every detail was designed to enhance user experience, from a visually engaging interface to an effortless ordering flow.",
    mark: "Mobile-first design",
    flag: "Intuitive menu browsing",
    cube: "One-tap reordering",
    search: "Real-time order tracking",
    order1: "order-1",
    order2: "order-2",
    link: "/case-studies1",
  },

  {
    ...
    mainDesc:
      "The revamped KFC Pakistan app delivered outstanding results, including:",
    mark: "Higher user engagement",
    flag: "Faster order placements",
    cube: "Improved customer satisfaction",
    search: "ncreased sales",
    order1: "order-2",
    order2: "order-1",
  },
];
        ...
        <div className="grid grid-cols-3 gap-4 pt-[100px]">
          <div className="col-span-2 pe-20">
            ...
            <p className="text-black/30 text-base font-syne mb-[20px] mt-[20px]">
              KFC Pakistan needed a mobile app that wasn’t just functional but
              truly user-friendly. Customers wanted a smoother, faster way to
              place their orders without any friction. The existing experience
              was clunky, making it harder for users to navigate, customize
              their meals, and complete purchases quickly. To maintain its
              competitive edge in the fast-food industry, KFC had to revamp its
            ...
            <div className="mt-[30px] grid grid-cols-2 gap-4">
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                ...
                <p className="text-lg font-syne">clean, minimalistic design </p>
              </div>
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
                <p className="text-lg font-syne">
                  Simple navigation and a logical menu structure{" "}
                </p>
              </div>
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
              ...
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
                <p className="text-lg font-syne">Performance optimization</p>
              </div>
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
                <p className="text-lg font-syne">A visually appealing UI</p>
              </div>
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
                <p className="text-lg font-syne">Customizable meal options</p>
              </div>
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
                <p className="text-lg font-syne">
        ...
        <div className="grid grid-cols-2 my-[90px]">
          <div>
            ...
            <p className="text-black/30">
              By prioritizing user experience and intuitive design, we
              transformed KFC Pakistan’s mobile ordering system into a seamless
              and efficient platform. The result? A high-performing,
              customer-friendly app that not only boosted engagement but also
              strengthened KFC’s digital presence. This case study proves that
              when design meets functionality, businesses can elevate customer
