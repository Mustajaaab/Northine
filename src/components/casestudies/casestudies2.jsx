...
const slides = [
  {
    ...
    mainDesc:
      "We designed a sleek, mobile-first app in Figma, focusing on ease of use and convenience. Key features of the solution included:",
    mark: "Quick and hassle-free sign-up",
    flag: "Easy installment management",
    cube: "Seamless checkout integration",
    search: "Smart notifications",
    order1: "order-1",
    order2: "order-2",
    link: "/case-studies1",
  },

  {
    ...
    mainDesc:
      "The redesigned BaadMay app led to:",
    mark: "Higher customer engagement",
    flag: "Increased conversion rates",
    cube: "Greater financial flexibility for users",
    search: "Improved user satisfaction",
    order1: "order-2",
    order2: "order-1",
  },
];
        ...
        <div className="grid grid-cols-3 gap-4 pt-[100px]">
          <div className="col-span-2 pe-20">
            ...
            <p className="text-black/30 text-base font-syne mb-[20px] mt-[20px]">
              BaadMay needed a user-friendly digital platform that would empower
              shoppers to make purchases without financial strain while ensuring
            ...
            <div className="mt-[30px] grid grid-cols-2 gap-4">
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                ...
                <p className="text-lg font-syne">
                  A minimalistic, intuitive interface
                </p>
              </div>
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
                <p className="text-lg font-syne">
                  A simplified "Buy Now, Pay Later" process{" "}
                </p>
              </div>
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
              ...
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
                <p className="text-lg font-syne">A frictionless onboarding experience,</p>
              </div>
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
                <p className="text-lg font-syne">Secure and seamless payment integration</p>
              </div>
              <div className="flex items-center gap-2 lg:mt-0 mt-1">
                <img src={tickk} alt="tick" className="w-10 h-9" />
                <p className="text-lg font-syne">Personalized notifications and reminders</p>
              </div>
