        ...
        <div className="bg-[#121820] ">
            ...
            <div className="pt-[290px] pb-[171px]  animate-fadeInSlideDown">
                ...
                <div className="flex mt-14">
                    <button className="text-white text-base font-normal py-5 px-14 border-[2px] border-[#fdcb22] rounded-full hover:bg-[#fdcb22] ease-out duration-300 hover:scale-110">Let&apos;s Talk</button>
