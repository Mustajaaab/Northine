    ...
    <>
        ...
        <div className="container w-[95%] mx-auto flex justify-between items-center">
          <div>
            <div className="flex items-center gap-5">
              ...
              <p className="text-lg font-syne font-[100]">Privacy</p>
            </div>
            <h1 className="lg:text-5xl text-3xl  font-syne mt-10 font-semibold">
              Privacy Policy
            </h1>
          </div>
      ...
      <div className="container w-[95%] mx-auto ">
        ...
        <p className="text-black/30 text-base font-syne mb-[20px] mt-[20px]">
          NorthNine Private Limited ("NorthNine," "we," "our," or "us") is
          committed to protecting your personal information and respecting your
          privacy. This Privacy Policy explains how we collect, use, disclose,
          and safeguard your information when you visit our website,
          https://northnine.pk, or use our services. By accessing or using our
        ...
        <p className="text-black/30 text-base font-syne mb-[20px] mt-[20px]">
          ...
          services. When you fill out a contact form, we collect your name,
          email address, phone number, and any additional details you provide.
          If you inquire about our services, we may collect information such as
          your company name and specific project requirements to better assist
          you. We automatically gather certain information to enhance your
          experience and improve our services. This includes device details such
          as your IP address, browser type, operating system, and device type.
          We also track usage data, including pages viewed, time spent on the
          website, and referring URLs. To provide a seamless experience, we use
          cookies that store small text files on your device. For more
          information, refer to our Cookie Policy Additionally, we may receive
          data from third-party tools integrated into our website, such as
          analytics providers. This helps us understand user interactions,
          monitor website performance, and continually improve the quality of
          our services.
        </p>
        <h2 className="font-syne lg:text-[25px] text-2xl font-semibold w-[80%] mt-[50px]">
        ...
        <p className="text-black/30 text-base font-syne mb-[20px] mt-[20px]">
          We use the information collected to provide, operate, and improve our
          services. It helps us respond to inquiries or requests, personalize
          your website experience, monitor and analyze website performance, and
        ...
        <p className="text-black/30 text-base font-syne mb-[20px] mt-[20px]">
          ...
          share your information in specific scenarios. This includes sharing
          information with trusted third-party vendors who assist with website
          operations and services. We may also share information to comply with
          applicable laws or respond to valid legal requests. In the event of
          mergers, acquisitions, or sales of assets, user information may be
          transferred as part of business transitions.
        </p>
        <h2 className="font-syne lg:text-[25px] text-2xl font-semibold w-[80%] mt-[50px]">
          Your Choices and Rights
        </h2>
        <p className="text-black/30 text-base font-syne mb-[20px] mt-[20px]">
          You have the right to access and review the personal information we
          hold about you. If needed, you can request the deletion of your
          personal data by contacting us at info@northnine.pk. Additionally, you
        ...
        <p className="text-black/30 text-base font-syne mb-[20px] mt-[20px]">
          ...
          This includes encryption of sensitive data, regular website security
          scans, and limiting access to personal information to authorized
          personnel only.
        </p>
        <h2 className="font-syne lg:text-[25px] text-2xl font-semibold w-[80%] mt-[50px]">
          Cookie Policy
        ...
        <p className="text-black/30 text-base font-syne mb-[20px] mt-[20px]">
          ...
          browsing experience and website functionality. We use cookies to
          enhance website performance, track and analyze usage patterns, and
          remember user preferences. There are three types of cookies we use:
          <br />
          Essential Cookies: Necessary for the operation of our website.
          <br />
          Performance Cookies: Help us analyze website traffic and usage
          patterns.
          <br />
          Functional Cookies: Remember your preferences to enhance the user
          experience.
          <br />
        ...
        <p className="text-black/30 text-base font-syne mb-[20px] mt-[20px]">
          ...
          Please review their privacy policies when visiting these sites.
        </p>
        <h2 className="font-syne lg:text-[25px] text-2xl font-semibold w-[80%] mt-[50px]">
          Changes to This Privacy Policy
        </h2>
        <p className="text-black/30 text-base font-syne mb-[20px] mt-[20px]">
          Updates to this Privacy Policy will be posted on this page with the
        ...
        <p className="text-black/30 text-base font-syne mb-[20px] mt-[20px]">
          NorthNine Private Limited
          <br /> Email: info@northnine.pk
          <br /> Phone: +92 3555 976065 <br />
          Thank you for trusting NorthNine Private Limited. Your privacy is our
          priority.
        </p>
      </div>
    </>
