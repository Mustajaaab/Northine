  ...
  return (
    <>
      ...
      >
        <div className="lg:container w-[90%] mx-auto flex justify-between items-center">
          <div>
            ...
            <h1 className=" text-3xl lg:text-5xl font-syne mt-10 font-semibold">
              ENTERPRISE
            </h1>
          </div>
      ...
      <div className="flex justify-center bg-slate-50">
        <div className="lg:container w-[90%] mx-auto lg:flex lg:justify-between my-20">
          <h2 className="font-syne text-2xl font-semibold">
            Digital Edge Solutions{" "}
            <span className="text-yellow">For Your Online Venture</span> <br />
            Success{" "}
          </h2>

          <div className="lg:flex lg:items-center lg:gap-6 grid justify-center">
            <button className="px-10 py-3 border-[2px] border-yellow rounded-full font-syne font-medium hover:border-[4px] duration-200 lg:mt-0 mt-12 ">
              Talk To an Expert
            </button>
            <button className="flex items-center gap-5 group lg:mt-0 mt-6">
              ...
              <p className="font-syne font-medium group-hover:text-yellow">
                Watch Video
              </p>
            </button>
          </div>
        ...
        <div className="lg:flex pb-20 container mx-auto justify-between">
          ...
          <div className="mt-4 lg:mt-4 w-[90%] lg:w-full lg:mx-0 mx-auto lg:space-x-32">
            <div className="flex items-center gap-4 justify-start ml-0 lg:ml-32 mt-10 ">
              ...
              <p className="font-syne"> Overview</p>
            </div>
            <h1 className="lg:text-5xl text-3xl font-syne font-semibold lg:leading-[70px] leading-[40px] mt-[60px]">
              We Specialize in <br />
              <span className="text-yellow">
                Transforming Your Idea
              </span> or <br className="hidden lg:block" /> Business in The
              Current <br />
              Digital Era.
            </h1>
            <p className="text-black/30 font-syne mt-[60px]">
              Your digital dreams are our dreams, and we navigate the virtual
              universe <br className="hidden lg:block" />
              ifor you. With the help of our digital edge services, we turn your{" "}
              <br />
              brand into a potent online force through a passion for
              <br />
            ...
            <div className="mt-[50px] lg:flex  gap-[150px]">
              <div>
                <div className="flex items-center gap-2 lg:mt-0 mt-1">
                  ...
                  <p className="text-lg font-syne">UI/UX Design.</p>
                </div>
                <div className="flex items-center gap-2 lg:mt-0 mt-1">
                  <img src={tickk} alt="" className="w-10 h-9" />
                ...
                <div className="flex items-center gap-2 lg:mt-0 mt-1">
                  <img src={tickk} alt="" className="w-10 h-9" />
                  <p className="text-lg font-syne">Web Development</p>
                </div>
                <div className="flex items-center gap-2 lg:mt-0 mt-1">
                  <img src={tickk} alt="" className="w-10 h-9" />
                  <p className="text-lg font-syne">BookKeeping / Accounting</p>
                </div>
                <div className="flex items-center gap-2 lg:mt-0 mt-1">
                  <img src={tickk} alt="" className="w-10 h-9" />
                  <p className="text-lg font-syne">
              ...
              <div className="flex items-center gap-10 lg:mt-5 mt-16">
                ...
                <div>
                  <p className="text-yellow font-satisfy font-bold text-[30px]">
                    Jami Baig
                  </p>
      ...
      <div className="lg:flex justify-end w-[40%] hidden ">
        <img src={Shades} alt="" className="w-[200px]" />
      </div>
      <div className="mx-auto lg:container w-[90%] lg:flex justify-between items-center">
        <div>
          <h1 className="lg:text-[64px] text-4xl  font-syne font-semibold mt-[60px] lg:mt-0">
            5000
            <span className="text-yellow ">+</span>
          </h1>
          <p className="font-syne text-lg mt-4 ">Clients Work</p>
          <h2 className="lg:text-[44px] text-3xl font-syne font-semibold mt-[60px] ">
            Ready To Take The Next Step?
          </h2>
        </div>
        <div>
          <h2 className="text-[26px] font-syne mt-[60px] lg:mt-0 font-semibold">
            Over 5,000+{" "}
            <span className="text-yellow ">successful projects</span>{" "}
            <br className="lg:hidden" /> and counting,
            <br /> each one a story of innovation, trust, and{" "}
            <span className="text-yellow ">
              excellence <br />
            </span>
          </h2>
          ...
          <div>
            <div className="lg:flex items-center gap-8 mt-[40px]">
              <div className="w-full">
                <p className="text-base font-semibold font-syne">
                  <span className="text-yellow mr-2">16+</span>
                  Strategic Approach
                </p>
              ...
              <div className="w-full">
                <p className="text-base font-semibold font-syne mt-[64px] lg:mt-0">
                  <span className="text-yellow mr-2">3+</span>Innovation
                </p>
                <div className="flex gap-1 w-full mt-10">
                  <div className="w-[10%] h-[2px] bg-yellow"></div>
                  <div className="w-[90%] h-[2px] bg-gray-300"></div>
            ...
            <div className="lg:flex items-center gap-8 mt-[40px]">
              <div className="w-full">
                <p className="text-base font-semibold font-syne mt-[64px] lg:mt-0">
                  <span className="text-yellow mr-2">360+</span>
              ...
              <div className="w-full">
                <p className="text-base font-semibold font-syne mt-[64px] lg:mt-0">
                  <span className="text-yellow mr-2">520+</span>
      ...
      <div className="lg:container w-[90%] flex mx-auto pb-3 gap-1 mt-[120px]">
        ...
        <div className="lg:flex container mx-auto justify-between items-center pb-[90px]">
          ...
          <div className="lg:w-full w-[95%] mx-auto space-x-0 lg:space-x-32">
            <div className="flex gap-2 items-center mt-[50px] ml-0 lg:ml-32">
              ...
              <p className="font-syne text-lg">Digital Solutions</p>
            </div>
            <h1 className="text-5xl font-syne font-semibold mt-[50px]">
              Our Mission
            </h1>
            <p className="mt-[50px] font-syne text-black/30">
              Propel brands forward, boost market share, and foster business
              growth through <br className="lg:block hidden" />
              digital expertise. We're dedicated to guiding clients through the
              digital landscape. <br className="lg:block hidden" />
            </p>
      ...
      <div className="lg:container w-[95%] mx-auto mt-[100px]">
        ...
        <h1 className="font-syne font-semibold lg:text-5xl text-3xl mt-10">
          Why Work With Us
        </h1>
      </div>
      <div className="lg:container w-[95%] flex mx-auto pb-3 gap-1 mt-[120px]">
        <div className="w-[2%] h-[2px] bg-yellow"></div>
        <div className="w-[96%] h-[2px] bg-[#121820]/10"></div>
        <div className="w-[2%] h-[2px] bg-yellow"></div>
      </div>
      <div className="lg:flex items-center lg:container w-[95%] mx-auto justify-between mt-[70px]">
        <div className="lg:flex items-end gap-[200px]">
          ...
          <h2 className="text-2xl font-syne font-semibold lg:mt-0 mt-6">
            Strategic Approach
          </h2>
        </div>
        <p className="font-syne text-black/30 lg:mt-0 mt-6">
          We don't just build websites; we craft digital experiences that align
          with your business <br /> objectives.
        </p>
      </div>
      <div className="lg:container w-[95%] flex mx-auto pb-3 gap-1 mt-[70px]">
        <div className="w-[2%] h-[2px] bg-yellow"></div>
        <div className="w-[96%] h-[2px] bg-[#121820]/10"></div>
        <div className="w-[2%] h-[2px] bg-yellow"></div>
      </div>
      <div className="lg:flex items-center lg:container w-[95%] mx-auto justify-between mt-[70px]">
        ...
        <p className="font-syne text-black/30 lg:mt-0 mt-6">
          Our team stays ahead of industry trends, incorporating the latest
          technologies for optimal <br /> performance.
        </p>
      </div>
      <div className="lg:container w-[95%] flex mx-auto pb-3 gap-1 mt-[70px]">
        <div className="w-[2%] h-[2px] bg-yellow"></div>
      ...
      <div className="lg:flex items-center lg:container w-[95%] mx-auto justify-between mt-[70px]">
        ...
        <p className="font-syne text-black/30 lg:mt-0 mt-6">
          Your success is our success. We work closely with you, ensuring
      ...
      <div className="lg:flex items-center lg:container w-[95%] mx-auto justify-between mt-[70px]">
        ...
        <p className="font-syne text-black/30 lg:mt-0 mt-6">
          Every business is unique, and so are our strategies. We design
          solutions specifically tailored
          <br />
          to your tailored to your brand's identity and goals
        </p>
      </div>
      <div className="lg:container w-[95%] flex mx-auto pb-3 gap-1 mt-[70px]">
        <div className="w-[2%] h-[2px] bg-yellow"></div>
      ...
      <div className="lg:flex items-center lg:container w-[95%] mx-auto justify-between mt-[70px]">
        ...
        <p className="font-syne text-black/30 lg:mt-0 mt-6">
          With a track record of 5,000+ successful projects, we have the
          experience and expertise to <br />
          deliver measurable outcomes that exceed expectations.
        </p>
      </div>
      <div className="lg:container w-[95%] flex mx-auto pb-3 gap-1 mt-[70px] mb-[120px]">
        <div className="w-[2%] h-[2px] bg-yellow"></div>
        <div className="w-[96%] h-[2px] bg-[#121820]/10"></div>
        <div className="w-[2%] h-[2px] bg-yellow"></div>
      </div>
      <div className="bg-[#f3f4f2] pb-[120px] ">
        <div className="w-[75%] lg:flex justify-end hidden">
          <img src={Shades} alt="" className="w-[220px]" />
        </div>
        <div className="lg:container w-[90%] mx-auto">
          <div className="flex gap-2 items-center lg:pt-0 pt-6">
            <span className="w-3 h-3 bg-yellow rounded-full"></span>
            <p className="font-syne font-semibold">For Enterprise</p>
          </div>
          <h1 className="lg:text-[42px] text-3xl font-syne font-semibold mt-[30px]">
            We Live by <span className="text-yellow">Powerful</span> Values
          </h1>
          <div className="lg:flex justify-between mt-[120px]">
            <div>
              ...
              <h3 className="font-syne font-semibold text-xl mt-9">
                Integrity First{" "}
              </h3>
              <p className="font-syne text-black/30 mt-9">
                We are committed to honesty and transparency in all our <br />{" "}
                interactions, ensuring trust forms the foundation of our <br />
                partnerships.{" "}
              </p>
            </div>
            <div className="mt-[70px] lg:mt-0">
              ...
              <p className="font-syne text-black/30 mt-9">
                We are constantly pushing boundaries to deliver cutting-edge{" "}
                <br /> solutions that elevate your business in a fast-evolving{" "}
                <br />
                digital landscape.{" "}
              </p>
            </div>
            <div className="mt-[70px] lg:mt-0">
              ...
              <p className="font-syne text-black/30 mt-9">
                We are dedicated to understanding your unique needs and <br />{" "}
                delivering tailored strategies that align perfectly with <br />
                your goals.
              </p>
            </div>
          </div>
          <div className="lg:flex justify-between mt-[70px]">
            <div>
              ...
              <p className="font-syne text-black/30 mt-9">
                We are firm believers in teamwork, fostering a collaborative{" "}
                <br /> environment where your input is valued and our expertise
                <br />
                delivers results.
              </p>
            </div>
            <div className="mt-[70px] lg:mt-0">
              ...
              <p className="font-syne text-black/30 mt-9">
                We are focused on delivering high-quality outcomes with <br />{" "}
                precision and efficiency, ensuring every project exceeds <br />
                expectations.
              </p>
            </div>
            <div className="mt-[70px] lg:mt-0">
              ...
              <p className="font-syne text-black/30 mt-9">
                We are passionate about driving growth—not just for our <br />{" "}
                clients but also for our team and the communities we <br />
                serve.
              </p>
            </div>
          </div>
