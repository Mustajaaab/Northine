    ...
    return (
        <>
            ...
            <div className="flex justify-center bg-slate-50">
                <div className="lg:container w-[90%] mx-auto lg:flex lg:justify-between my-20">
                    ...
                    <div className="lg:flex lg:items-center lg:gap-6 grid justify-center">
                        <button className="px-10 py-3 border-[2px] border-yellow rounded-full font-syne font-medium hover:border-[4px] duration-200 lg:mt-0 mt-12 ">Talk To an Expert</button>
            ...
            <div className="bg-[#f3f4f2]">
                ...
                <div className="lg:flex pb-20 container mx-auto justify-between">
                    ...
                    <div className="mt-4 lg:mt-4 w-[90%] lg:w-full lg:mx-0 mx-auto lg:space-x-32">
                        ...
                        <h1 className="lg:text-5xl text-3xl font-syne font-semibold lg:leading-[70px] leading-[40px] mt-[60px]">We Specialize in <br />
                            <span className="text-yellow">Transforming Your Idea</span> or <br className="hidden lg:block" /> Business in The Current <br />
                            Digital Era.</h1>
                        ...
                        <div className="mt-[50px] lg:flex  gap-[150px]">
                            ...
                            <div className="flex items-center gap-10 lg:mt-5 mt-16">
                                ...
                                <div>
                                    <p className="text-yellow font-satisfy font-bold text-[30px]">Jane Meldrum</p>
            ...
            <div className="mx-auto lg:container w-[90%] lg:flex justify-between items-center">
                <div>
                    <h1 className="lg:text-[64px] text-4xl  font-syne font-semibold mt-[60px] lg:mt-0">8<span className="text-yellow ">+</span></h1>
                ...
                <div>
                    ...
                    <div>
                        <div className="lg:flex items-center gap-8 mt-[40px]">
                            ...
                            <div className="w-full">
                                <p className="text-base font-semibold font-syne mt-[64px] lg:mt-0"><span className="text-yellow mr-2">3+</span>Software Development</p>
                                <div className="flex gap-1 w-full mt-10">
                                    <div className="w-[10%] h-[2px] bg-yellow"></div>
                                    <div className="w-[90%] h-[2px] bg-gray-300"></div>
                                </div>
                        ...
                        <div className="lg:flex items-center gap-8 mt-[40px]">
                            <div className="w-full">
                                <p className="text-base font-semibold font-syne mt-[64px] lg:mt-0"><span className="text-yellow mr-2">360+</span>Software Development</p>
                                <div className="flex gap-1 w-full mt-10">
                                    <div className="w-[10%] h-[2px] bg-yellow"></div>
                                    <div className="w-[90%] h-[2px] bg-gray-300"></div>
                                </div>
                            ...
                            <div className="w-full">
                                <p className="text-base font-semibold font-syne mt-[64px] lg:mt-0"><span className="text-yellow mr-2">520+</span>Software Development</p>
                                <div className="flex gap-1 w-full mt-10">
                                    <div className="w-[10%] h-[2px] bg-yellow"></div>
                                    <div className="w-[90%] h-[2px] bg-gray-300"></div>
                                </div>
            ...
            <div className="bg-[#f3f4f2] pb-[120px] ">
                ...
                <div className="lg:container w-[90%] mx-auto">
                    ...
                    <h1 className="lg:text-[42px] text-3xl font-syne font-semibold mt-[30px]">We Live by <span className="text-yellow">Powerful</span> Values</h1>
